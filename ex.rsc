# 2026-03-23 07:15:58 by RouterOS 7.22
...
add address=192.168.0.1/24 comment="add address=192.168.0.1/24 interface=ether\
    2   \E2\86\90 \D0\B4\D0\BE\D0\BB\D0\B6\D0\BD\D0\BE \D0\B1\D1\8B\D1\82\D1\
    \8C interface=bridge1 \D0\9A\D0\BB\D0\B8\D0\B5\D0\BD\D1\82\D1\8B \D0\BD\D0\
    \B0 \D0\B4\D1\80\D1\83\D0\B3\D0\B8\D1\85 \D0\BF\D0\BE\D1\80\D1\82\D0\B0\D1\
    \85 (ether3\E2\80\93ether8) \D0\BD\D0\B5 \D0\BF\D0\BE\D0\BB\D1\83\D1\87\D0\
    \B0\D1\82 \D1\88\D0\BB\D1\8E\D0\B7." interface=ether2 network=192.168.0.0
...
add address=44.192.0.0/11 disabled=yes list=bl_pz
add address=46.166.96.0/19 list=bl_pz
add address=194.124.36.0/24 list=bl_pz
add address=44.192.0.0/10 disabled=yes list=bl_pz
...
add comment="bypass WG: gurmina.by" disabled=yes distance=1 dst-address=\
    93.125.99.128/32 gateway=82.209.233.129 routing-table=main scope=30 \
    target-scope=10
add comment="bypass WG: 185.73.194.77 ozon.by" disabled=no distance=1 \
    dst-address=185.73.195.108/32 gateway=82.209.233.129 routing-table=main \
    scope=30 target-scope=10
add comment="Default via WireGuard" distance=1 dst-address=0.0.0.0/0 gateway=\
    wg1 routing-table=main
add comment="ozon.ru [185.73.194.82]" disabled=no distance=1 dst-address=\
    185.73.194.0/24 gateway=ether1 routing-table=main scope=30 target-scope=\
    10
/ip service
set ftp disabled=yes
